/*
  ...
  Revision History
  ----------------
  Jul 2022 - version 1.1
  - Changed the order of the digitPins
  - Swapped digit pins 5 and 6
  - Changed DIGIT_ON and DIGIT_OFF to be inverted
  - Added REPEAT_PRESS as well as LONG_PRESS as the switch on Rotary Encoder does not support LONG_PRESS
...
const uint8_t digitPin[] = { 7, 5, 6, 4 };
